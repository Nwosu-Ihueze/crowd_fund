...
const line = document.querySelectorAll('.nav-menu .line');
const ul = document.querySelector('.navbar .nav-links');
const tags = document.querySelectorAll('.navbar .nav-links a');
...
const hideCard= document.querySelector('#hiddenModal');
const closeHidee = document.querySelectorAll('.closeHidee');
let toggleCard = false; 
function openCard(open,hiddenModal) {
...
function closeCard(close, hiddenModal) {
...
closeHidee.forEach((item)=>{
    item.addEventListener('click',()=>{
        ...
        .to(successModal, 0.2, { opacity:"1", pointerEvents: "all"}  );
    })
});
...
function successOpen(item){
    item.addEventListener('click', ()=>{
        ...
        time.to(successModal, 0.2, {opacity:"1", pointerEvents: "all"},"+=.55");
    })
};
...
closeHideCard(closeSuccess,successModal);
